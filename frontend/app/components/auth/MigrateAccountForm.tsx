...
export default function MigrateAccountForm({
    ...
    return (
        <>
            ...
            <p className="text-[#bbb] text-center text-[0.9rem] mb-2">Set your email and password to secure your account.</p>
            ...
            <span className="relative w-full group">
                ...
                <input name="name" className="p-4 pl-10.75 [text-indent:1px] rounded-[10px] border border-[#333] bg-[#252525] text-white w-full box-border" type="text" placeholder="Name" defaultValue={defaultName} required />
            </span>
            ...
            <button type="button" className="text-[#888] text-[0.8rem] cursor-pointer hover:text-white transition-colors bg-transparent border-none p-0 mt-2" onClick={handleBackToLogin}>
                Back to Login
            </button>
        </>
    );
